...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Location.logo'
        raise RuntimeError("Cannot reverse this migration. 'Location.logo' and its values cannot be restored.")
