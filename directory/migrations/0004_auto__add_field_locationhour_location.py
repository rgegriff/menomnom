...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('directory_locationhour', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='loc', to=orm['directory.Location']),
                      keep_default=False)
    ...
    models = {
        'directory.location': {
            ...
            'hours': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'hour'", 'symmetrical': 'False', 'to': "orm['directory.LocationHour']"}),
        ...
        'directory.locationhour': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'loc'", 'to': "orm['directory.Location']"}),
