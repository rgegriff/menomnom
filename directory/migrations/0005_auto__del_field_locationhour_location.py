...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'LocationHour.location'
        raise RuntimeError("Cannot reverse this migration. 'LocationHour.location' and its values cannot be restored.")
    ...
    models = {
        'directory.location': {
            ...
            'hours': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'location'", 'symmetrical': 'False', 'to': "orm['directory.LocationHour']"}),
