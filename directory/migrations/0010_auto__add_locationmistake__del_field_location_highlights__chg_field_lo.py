...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationMistake'
        db.create_table('directory_locationmistake', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('directory', ['LocationMistake'])

        # Deleting field 'Location.highlights'
        db.delete_column('directory_location', 'highlights_id')


        # Changing field 'Location.description'
        db.alter_column('directory_location', 'description', self.gf('django.db.models.fields.TextField')(max_length=350, null=True))
        # Adding field 'LocationHighlight.location'
        db.add_column('directory_locationhighlight', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='location_highlights', to=orm['directory.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LocationMistake'
        db.delete_table('directory_locationmistake')

        # Adding field 'Location.highlights'
        db.add_column('directory_location', 'highlights',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.LocationHighlight'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Location.description'
        db.alter_column('directory_location', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=350))
        # Deleting field 'LocationHighlight.location'
        db.delete_column('directory_locationhighlight', 'location_id')
