...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocationSpecial.site'
        db.add_column('directory_locationspecial', 'site',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LocationSpecial.site'
        db.delete_column('directory_locationspecial', 'site_id')
