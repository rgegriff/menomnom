...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagerProfile.user'
        db.add_column('management_managerprofile', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagerProfile.user'
        db.delete_column('management_managerprofile', 'user_id')
