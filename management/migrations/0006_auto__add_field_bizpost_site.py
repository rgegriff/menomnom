...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BizPost.site'
        db.add_column('management_bizpost', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BizPost.site'
        db.delete_column('management_bizpost', 'site_id')
    ...
    models = {
        ...
        'management.managerprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'manager'", 'unique': 'True', 'null': 'True', 'to': "orm['auth.User']"})
        },
        'sites.site': {
