...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('socialize_message', (
            ...
            ('message', self.gf('django.db.models.fields.TextField')(max_length=240)),
        ))
        db.send_create_signal('socialize', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table('socialize_message')
    ...
    models = {
        ...
        'socialize.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {'max_length': '240'}),
