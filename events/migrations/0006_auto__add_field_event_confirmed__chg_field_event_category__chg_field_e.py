...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.confirmed'
        db.add_column('events_event', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Event.category'
        db.alter_column('events_event', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventCategory'], null=True))
        ...
        # Changing field 'Event.img'
        db.alter_column('events_event', 'img', self.gf('django_thumbs.db.models.ImageWithThumbsField')(name='img', sizes=((144, 144), (200, 200)), max_length=100, null=True))

        # Changing field 'Event.slug'
        db.alter_column('events_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True))

        # Changing field 'Event.location'
        db.alter_column('events_event', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventLocation'], null=True))

    def backwards(self, orm):
        # Deleting field 'Event.confirmed'
        db.delete_column('events_event', 'confirmed')


        # Changing field 'Event.category'
        db.alter_column('events_event', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=True, to=orm['events.EventCategory']))
        ...
        # Changing field 'Event.img'
        db.alter_column('events_event', 'img', self.gf('django_thumbs.db.models.ImageWithThumbsField')(max_length=100, null=True, name='img', sizes=((144, 144),)))

        # User chose to not deal with backwards NULL issues for 'Event.slug'
        raise RuntimeError("Cannot reverse this migration. 'Event.slug' and its values cannot be restored.")
